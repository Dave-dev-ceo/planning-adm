...
class AgregarMachote extends StatefulWidget {
  ...
  const AgregarMachote({Key key, this.descripcionMachote}) : super(key: key);
  ...
  _AgregarMachoteState createState() =>
      _AgregarMachoteState(descripcionMachote);
}
...
class _AgregarMachoteState extends State<AgregarMachote> {
  ...
  _AgregarMachoteState(this.descripcionMachote);
  @override
  void initState() {
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
          ...
          machotesBloc.add(CreateMachotesEvent(
              {"descripcion": descripcionMachote, "machote": txt},
              itemModelMC));
