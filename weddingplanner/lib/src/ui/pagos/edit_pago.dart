      ...
      child: BlocBuilder<PagosBloc, PagosState>(
        builder: (context, state) {
          if(state is PagosInitial) {
            ...
            if(bandera){
              itemPago['servicios'] = state.pagos.pagos[0].idServicio.toString();
              itemPago['proveedores'] = state.pagos.pagos[0].idProveedor.toString();
              itemPago['cantidad'] = state.pagos.pagos[0].cantidad.toString();
              itemPago['descripcion'] = state.pagos.pagos[0].descripcion.toString();
              itemPago['precio'] = state.pagos.pagos[0].precioUnitario.toString();
        ...
        children: [
          Column(
            ...
            children: [
              ...
              Text('Concepto:'),
              TextFormField(
                controller: TextEditingController(text: '${itemPago['descripcion']}'),
                decoration: InputDecoration(
                  hintText: 'Concepto:'
                ),
                onChanged: (valor) {
              ...
              Text('Anticipo:'),
              TextFormField(
                controller: TextEditingController(text: '${itemPago['anticipo']}'),
                decoration: InputDecoration(
                  hintText: 'Anticipo:'
                ),
                keyboardType: TextInputType.number,
