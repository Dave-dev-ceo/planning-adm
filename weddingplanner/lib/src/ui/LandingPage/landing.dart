          ...
          child: Column(
            children: [
              Container(
                ...
                child: FittedBox(
                  child: Image.network(
                      'https://www.hola.com/imagenes/novias/20210410187228/vestidos-novia-desmontables/0-937-364/portada-vestidos-desmontables-m.jpg'),
                  fit: BoxFit.fill,
                ),
              ),
              Padding(
                  ...
                  child: Title(
                      color: Colors.black,
                      child: Text(
                        '¿Vestidos de novia lenceros? Descubre si es el estilo que necesitas para tu boda',
                        style: TextStyle(
