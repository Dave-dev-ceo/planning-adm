...
class _AgregarPlanesState extends State<AgregarPlanes> {
  ...
  Container _header() {
    return Container(
      ...
      color: Colors.white,
      child: Text('Selecciona los planes para tu evento', style: TextStyle(fontSize: 20.0),),
    );
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          ElevatedButton(
            child: Text('Agregar'),
            onPressed: widget.lista.length > 0 ? _eventoAgregarData:_eventoAgregar,
          ),
        ],
      ),
    );
        ...
        if(tareaThere.idTareaOld == tareaHere.idTareaPlanner){
          ...
          tareaHere.actividadTareaPlanner.forEach((actividadHere) {
            tareaThere.actividadTareaPlanner.forEach((actividadThere) {
              if(actividadHere.idActividadPlanner == actividadThere.idOldActividad) {
                actividadHere.idActividadPlanner = actividadThere.idOldActividad;
        ...
        if(actividad.checkActividadPlanner) {
          actividadPlaner.add(
            ActividadPlanner(
              ...
              visibleInvolucradosActividadPlanner: actividad.visibleInvolucradosActividadPlanner,
