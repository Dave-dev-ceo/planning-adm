...
class PerfiladoLogic implements PermisosLogic {
  ...
  Future<ItemModelPerfil> obtenerPermisosUsuario() async {
    ...
    final response = await client.post(Uri.parse(confiC.url + confiC.puerto + '/wedding/USUARIOS/obtenerPermisosUsuario'),
    ...
    if (response.statusCode == 200) {
      ...
      ItemModelSecciones secciones = ItemModelSecciones.fromJson(data['secciones']);
      ItemModelPantallas pantallas = ItemModelPantallas.fromJson(data['pantallas']);
