...
abstract class AutorizacionLogic {
  ...
  Future<bool> updateAutorizacion(int idAuditorizacion, String descripcion, String comentario);
...
class ConsultasAutorizacionLogic extends AutorizacionLogic {
  ...
  Future<ItemModelAutorizacion> selectEvidencia(int idAuditorizacion) async {
    ...
    final response = await client.post(
      ...
      body: {'id_planner':idPlanner.toString(), 'id_auditoria':idAuditorizacion.toString()},
      headers: {HttpHeaders.authorizationHeader:token}
    );
  ...
  @override
  Future<bool> updateAutorizacion(int idAuditorizacion, String descripcion, String comentario) async {
    // variables
    int idPlanner = await _sharedPreferences.getIdPlanner();
    String token = await _sharedPreferences.getToken();
  ...
  Future<bool> deleteAutorizacion(int idAuditorizacion) async {
    ...
    final response = await client.post(
      ...
      body: {'id_planner':idPlanner.toString(), 'id_autorizacion':idAuditorizacion.toString()},
      headers: {HttpHeaders.authorizationHeader:token}
    );
  ...
  Future<bool> deleteImage(int idEvidencia) async {
    ...
    final response = await client.post(
      Uri.parse(
        confiC.url + 
        confiC.puerto +
        '/wedding/AUTORIZACION/deleteImage'
      ),
      body: {'id_planner':idPlanner.toString(), 'id_evidencia':idEvidencia.toString()},
      headers: {HttpHeaders.authorizationHeader:token}
    );
