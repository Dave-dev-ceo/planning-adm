...
class _MesasPageState extends State<MesasPage> {
  ...
  late InvitadosMesasBloc invitadosBloc;
      ...
      body: BlocBuilder<MesasAsignadasBloc, MesasAsignadasState>(
        builder: (context, state) {
          if (state is LoadingMesasAsignadasState) {
            ...
            if (state.listaMesasAsignadas.isNotEmpty) {
        ...
        SpeedDialChild(
          ...
          onTap: () {
            Navigator.of(context)
                .pushNamed('/asignarMesas', arguments: lastNumMesa)
                .then((value) => {
                      lastNumMesa = value as int? ?? 0,
                    });
          },
        ),
        SpeedDialChild(
    ...
    return FloatingActionButton(
      ...
      onPressed: () {
        Navigator.of(context)
            .pushNamed('/asignarMesas', arguments: lastNumMesa)
            .then((value) => {
                  lastNumMesa = value as int? ?? lastNumMesa,
                });
      },
    );
  }
                      ...
                      child: ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int i) {
                            ...
                            if (listaMesasAsignadas.isNotEmpty) {
                              final asigando = listaAsignados.firstWhereOrNull(
                                (a) => a.posicion == i + 1,
                              );
                              if (asigando != null) {
    ...
    Widget dropMenuSelectMesas = Padding(
        ...
        child: DropdownButtonFormField(
          ...
          items: listaDeMesas
              ...
              .toList(),
          value: listaDeMesas.firstWhereOrNull(
          ...
          onChanged: (dynamic value) {
            setState(() {
              ...
              listPosicionDisponible = List.generate(
                  mesaModelData!.dimension!, (index) => index + 1);
  ...
  _asignarAutoMesas() async {
    ...
    if (listaMesaFromDB.isNotEmpty && _listaInvitadoDisponibles!.isNotEmpty) {
      for (var invitado in _listaInvitadoDisponibles!) {
        final mesaDisponible = listaMesaFromDB.firstWhereOrNull((mesa) {
