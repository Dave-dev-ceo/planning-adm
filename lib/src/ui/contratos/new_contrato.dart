...
class NewContratoState extends State<NewContrato> {
  // variables bloc
  late ContratosDosBloc contratosBloc;
  late VerContratosBloc verContratos;
  ...
  // ini eventos Cards
  _verOldFile(int? idMachote, int? idContrato, String? tipoMime,
      String? tipoDoc, String? descripcion) {
    // if (idMachote != 0) {
    if (tipoDoc == 'html') {
