...
class _EditarEventoState extends State<EditarEvento> {
  ...
  late TextEditingController numbInvitadosCtrl;
  ...
  late TextEditingController nombreInvoCtrl;
  late TextEditingController telefonoInvoCtrl;
  late TextEditingController emailInvoCtrl;
  late TextEditingController passwdInvoCtrl;
  late TextEditingController passwdConfirmInvoCtrl;
  bool esUsr = false;
  ...
  // Blocs y Models
  late TiposEventosBloc tiposEventosBloc;
