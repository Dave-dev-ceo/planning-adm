...
class _ResumenEventoState extends State<ResumenEvento> {
  final Map<dynamic, dynamic>? detalleEvento;
  final bool? WP_EVT_RES_EDT;
  late evt_bloc.EventosBloc eventosBloc;
  ...
  miCardReportesInvitados(ItemModelReporteInvitados reporte) {
    ...
    final numAcompanantes = reporte.results
        .firstWhere((r) => r.estatus == 'Acompañantes')
        .cantidad!;
      ...
      child: Padding(
        ...
        child: StreamBuilder(
          ...
          builder: (context, snapshot) {
            if (snapshot.hasData) {
              final data = snapshot.data as ContadorActividadesModel;
              ...
              if (data.total! > 0) {
                return Column(
                  ...
                  children: [
                    ...
                    if (size.width > 400)
                      Row(
                        ...
                        children: [
                          ...
                          Text('${data.completadas.toString()} Completadas'),
                          const Spacer(),
                          Theme(
                          ...
                          Text('${data.pendientes.toString()} En Curso'),
                          const Spacer(),
                          Theme(
                          ...
                          Text('${data.atrasadas.toString()} Atrasadas'),
                          const Spacer(),
                        ],
                      )
                    else
                    ...
                    Text(
                        'Progreso ${((data.completadas! / data.total!) * 100).toStringAsFixed(0)}%'),
                    const SizedBox(
                      height: 10,
                    ),
                    Theme(
                      ...
                      child: ConstrainedBox(
                        ...
                        child: ClipRRect(
                          ...
                          child: LinearProgressIndicator(
                            minHeight: 5.0,
                            value: data.completadas! / data.total!,
