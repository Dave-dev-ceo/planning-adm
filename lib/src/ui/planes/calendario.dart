...
class CalendarioPlan extends StatefulWidget {
  ...
  const CalendarioPlan({Key? key, this.actividadesLista}) : super(key: key);
...
class _CalendarioPlanState extends State<CalendarioPlan> {
  ...
  // blocs
  late ComentariosactividadesBloc eventoComentario;
  ...
  void initState() {
    ...
    _focusedDay = DateTime.now()
            .isBefore(widget.actividadesLista!.first.fechaFinalEvento!)
