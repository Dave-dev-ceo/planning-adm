...
abstract class ComentariosActividadesLogic {
  ...
  Future<int> createComentarioPorId(
      String comentarioTxt, int idActividad, bool estadoComentario);
  Future<int> updateComentarioPorId(
      int idComentario, String comentarioTxt, bool estadoComentario);
}
